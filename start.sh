...
# ── Sydney Property Harness — identity bootstrap ──────────────────────────────
# Write SOUL.md from the image on every boot so it survives redeploys.
# The file is baked into docker/SOUL.md at build time; copying it here means
